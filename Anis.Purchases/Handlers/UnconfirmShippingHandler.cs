...
{
    public class UnconfirmShippingHandler : IRequestHandler<UnconfirmShippingCommand, Invoice>
    {
        private readonly ApplicationDbContext _context;

        public UnconfirmShippingHandler(ApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<Invoice> Handle(UnconfirmShippingCommand command, CancellationToken cancellationToken)
        {
            ...
            invoice.UnconfirmShipping(command);
