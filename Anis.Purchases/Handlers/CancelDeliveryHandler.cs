...
{
    public class CancelDeliveryHandler : IRequestHandler<CancelDeliveryCommand, Invoice>
    {
        private readonly ApplicationDbContext _context;

        public CancelDeliveryHandler(ApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<Invoice> Handle(CancelDeliveryCommand command, CancellationToken cancellationToken)
        {
            ...
            invoice.CancelDelivery(command);
