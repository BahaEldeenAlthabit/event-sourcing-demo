...
{
    public class RemoveShipmentHandler : IRequestHandler<RemoveShipmentCommand, Invoice>
    {
        private readonly ApplicationDbContext _context;

        public RemoveShipmentHandler(ApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<Invoice> Handle(RemoveShipmentCommand command, CancellationToken cancellationToken)
        {
            ...
            invoice.RemoveShipment(command);
