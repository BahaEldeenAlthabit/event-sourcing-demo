...
{
    public class DeliverHandler : IRequestHandler<DeliverCommand, Invoice>
    {
        private readonly ApplicationDbContext _context;

        public DeliverHandler(ApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<Invoice> Handle(DeliverCommand command, CancellationToken cancellationToken)
        {
