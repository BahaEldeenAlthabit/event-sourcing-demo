...
{
    public class ChangeDeadlineHandler : IRequestHandler<ChangeDeadlineCommand, Invoice>
    {
        private readonly ApplicationDbContext _context;

        public ChangeDeadlineHandler(ApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<Invoice> Handle(ChangeDeadlineCommand command, CancellationToken cancellationToken)
        {
            ...
            invoice.ChangeDeadline(command);
