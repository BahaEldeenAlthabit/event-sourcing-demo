...
{
    public class AssignSupplierHandler : IRequestHandler<AssignSupplierCommand, Invoice>
    {
        private readonly ApplicationDbContext _context;

        public AssignSupplierHandler(ApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<Invoice> Handle(AssignSupplierCommand command, CancellationToken cancellationToken)
        {
            ...
            invoice.AssignSupplier(command);
