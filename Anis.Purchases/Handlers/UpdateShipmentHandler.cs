...
{
    public class UpdateShipmentHandler : IRequestHandler<UpdateShipmentCommand, Invoice>
    {
        private readonly ApplicationDbContext _context;

        public UpdateShipmentHandler(ApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<Invoice> Handle(UpdateShipmentCommand command, CancellationToken cancellationToken)
        {
            ...
            invoice.UpdateShipment(command);
