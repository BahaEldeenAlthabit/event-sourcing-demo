...
{
    public class UpdateInvoiceInfoHandler : IRequestHandler<UpdateInvoiceInfoCommand, Invoice>
    {
        private readonly ApplicationDbContext _context;

        public UpdateInvoiceInfoHandler(ApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<Invoice> Handle(UpdateInvoiceInfoCommand command, CancellationToken cancellationToken)
        {
