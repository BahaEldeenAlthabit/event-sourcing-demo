...
{
    public class AddShipmentHandler : IRequestHandler<AddShipmentCommand, Invoice>
    {
        private readonly ApplicationDbContext _context;

        public AddShipmentHandler(ApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<Invoice> Handle(AddShipmentCommand command, CancellationToken cancellationToken)
        {
