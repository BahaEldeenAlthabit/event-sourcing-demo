...
{
    public class AdjustDamagedQuantityHandler : IRequestHandler<AdjustDamagedQuantityCommand, Invoice>
    {
        private readonly ApplicationDbContext _context;

        public AdjustDamagedQuantityHandler(ApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<Invoice> Handle(AdjustDamagedQuantityCommand command, CancellationToken cancellationToken)
        {
            ...
            invoice.AdjustDamagedQuantity(command);
