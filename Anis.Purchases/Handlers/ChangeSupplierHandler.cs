...
{
    public class ChangeSupplierHandler : IRequestHandler<ChangeSupplierCommand, Invoice>
    {
        private readonly ApplicationDbContext _context;

        public ChangeSupplierHandler(ApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<Invoice> Handle(ChangeSupplierCommand command, CancellationToken cancellationToken)
        {
            ...
            invoice.ChangeSupplier(command);
