...
{
    public class UpdateItemHandler : IRequestHandler<UpdateItemCommand, Invoice>
    {
        ...
        public async Task<Invoice> Handle(UpdateItemCommand command, CancellationToken cancellationToken)
        {
